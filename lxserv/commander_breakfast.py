import lx, modo, Jake_Higgs_Modo_Preferences

"""A simple example of a blessed MODO command using the commander module.
https://github.com/adamohern/commander for details"""


class CommandClass(Jake_Higgs_Modo_Preferences.CommanderClass):
...
lx.bless(CommandClass, 'Jake_Higgs_Modo_Preferences.breakfast')
